  ...
  if (bearer) {
    ...
    if (!!payload) {
        ...
        tailor
          ? col
              ...
              .then(async (response) => {
                if (response) {
                  if (
                    Object.keys(response).includes("customers") &&
                    response.customers
                  ) {
                    ...
                    var nd = data.filter((customer) => {
                      ...
                      return (
                        today.toDateString() ===
                        customer.dateCreated.toDateString()
                      );
                    });
      ...
      res
        ...
        .json({
          message:
            "payload, Uauthorized. Access is denied due to invalid credentials."
        });
    }
  } else {
    res
      ...
      .json({
        message:
          "bearer, Unauthorized. Access is denied due to invalid credentials."
      });
  }
};
